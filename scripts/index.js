...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const playlist = ["lagu1.wav", "lagu2.wav"];
  let currentTrack = 0;
...
const config = {
  birthdate: 'Mar 24, 2025',
  // name: 'Sheila Marwa Pratiwi'
  name:''
};
...
x = setInterval(function() {
  ...
  let w = (c.width = window.innerWidth),
    ...
    hh = h / 2,
    opts = {
      // strings: ['Happy Birthday Sayaang!', '', config.name],
      strings: ['', '', config.name],
      charSize: 30,
      charSpacing: 35,
      lineHeight: 40,
...
document.getElementById('giftbox').addEventListener('click', function() {
  // Redirect ke halaman birthday.html
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (giftBox) {
      giftBox.addEventListener("click", function () {
          // Sembunyikan gift box setelah diklik
          giftBox.style.display = "none";

          // Tampilkan kartu ucapan ulang tahun
          if (birthdayCard) {
